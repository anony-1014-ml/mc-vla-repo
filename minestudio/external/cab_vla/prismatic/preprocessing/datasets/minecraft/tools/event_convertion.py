...
FilePath: /minecraft/tools/event_convertion.py
'''
...
from prismatic.preprocessing.datasets.minecraft.callbacks import MetaInfoKernelCallback, ImageKernelCallback, ActionKernelCallback

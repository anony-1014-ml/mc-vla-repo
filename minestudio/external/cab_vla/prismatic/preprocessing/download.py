...
DATASET_REGISTRY: Dict[str, List[DatasetComponent]] = {
    ...
    "llava-v1.0-instruct": [
        {
            "name": "llava_instruct_150k.json",
            "extract": False,
            "url": (
                "file:///data/db/prism_train/download/llava-v1.0-instruct/llava_instruct_150k.json",
            ),
            "do_rename": True,
        },
        {
            "name": "coco_train2017",       # Visual Instruct Tuning images are all sourced from COCO Train 2017
            "extract": True,
            "extract_type": "directory",
            "url": "file:///data/db/prism_train/download/llava-v1.0-instruct/coco_train2017.zip",
            "do_rename": True,
        }
    ],
    ...
    "llava-v1.5-instruct": [
        {
            ...
            "extract": False,
            "url": (
                "file:///data/db/prism_train/download/llava-v1.5-instruct/llava_v1_5_mix665k.json"
            ),
            "do_rename": True,
        },
        {
            ...
            "extract": True,
            "extract_type": "directory",
            "url": "file:///data/db/prism_train/download/llava-v1.5-instruct/coco_train2017.zip",
            "do_rename": True,
        },
        {
            "name": "gqa/images",
            "extract": True,
            "extract_type": "directory",
            "url": "file:///data/db/prism_train/download/llava-v1.5-instruct/gqa_images.zip",
            "do_rename": True,
        },
        {
            "name": "ocr_vqa/images",
            "extract": True,
            "extract_type": "directory",
            "url": "file:///data/db/prism_train/download/llava-v1.5-instruct/ocr_vqa.zip",
            "do_rename": True,
        },
        {
            ...
            "extract": True,
            "extract_type": "directory",
            "url": "file:///data/db/prism_train/download/llava-v1.5-instruct/textvqa_train_val_images.zip",
            "do_rename": True,
        },
        {
            "name": "vg/VG_100K",
            "extract": True,
            "extract_type": "directory",
            "url": "file:///data/db/prism_train/download/llava-v1.5-instruct/vg_images.zip",
            "do_rename": True,
        },
        {
            "name": "vg/VG_100K_2",
            "extract": True,
            "extract_type": "directory",
            "url": "file:///data/db/prism_train/download/llava-v1.5-instruct/vg_images2.zip",
            "do_rename": True,
        },
    ]
}

...
# [Reproduction] LLaVa-v10 (exact dataset used in all public LLaVa-v10 models)
@dataclass
class LLaVa_V10_Config(DatasetConfig):
    dataset_id: str = "llava-v10"
    ...
    finetune_stage_components: Tuple[Path, Path] = (
        Path("download/llava-v1.0-instruct/llava_instruct_150k.json"),
        Path("download/llava-v1.0-instruct/coco_train2017"),
    )
    dataset_root_dir: Path = Path("data")

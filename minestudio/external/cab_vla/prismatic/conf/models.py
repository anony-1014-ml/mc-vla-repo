...
class ModelConfig(ChoiceRegistry):
    ...
    projector_id:str                                        # Pretrained projector to load
    action_head_id:str                                      # Pretrained action_head to load
    ...
    align_optimizer_type: str                               # Optimizer Type
    ...
    finetune_optimizer_type: str                            # Optimizer Type
...
class LLaVa_v15_Reproduction_7B(ModelConfig):
    ...
    align_optimizer_type: str = "AdamW"
    ...
    finetune_optimizer_type: str = "AdamW"
...
# === PrismPaliGemma ===
@dataclass
class Prism_PaliGemma_3B_PT_224(ModelConfig):
    model_id: str = "prism-paligemma-3b-pt-224"
    arch_specifier: str = "none"

    vision_backbone_id: str = "paligemma-3b-pt-224"
    llm_backbone_id: str = "paligemma-3b-pt-224"
    projector_id:str = "paligemma-3b-pt-224"
    action_head_id:str = "paligemma-vpt-cd-para" #"paligemma-vpt-cd" #"paligemma-vpt"

    image_resize_strategy: str = "resize-naive"
    llm_max_length: int = 1024 + 128 #1024 #2048
    ...
    # Finetune Stage Optimization Parameters
    finetune_epochs: int = 18 #10 #20
    finetune_max_steps: Optional[int] = None
    finetune_global_batch_size: int = 128 #128
    ...
    finetune_lr_scheduler_type: str = "linear-warmup+cosine-decay"
    finetune_warmup_ratio: float = 0.03
    finetune_optimizer_type: str = "AdamW" #"APOLLO" #"AdafactorT" #"AdafactorP"

    finetune_train_strategy: str = "fsdp2-full-shard" #"fsdp-full-shard"
...
class ModelRegistry(Enum):
    ...
    # === PrismPaliGemma ===
    PRISM_PALIGEMMA_3B_PT_224 = Prism_PaliGemma_3B_PT_224

...
class FSDPStrategy(TrainingStrategy):
    ...
    def run_setup(self, run_dir: Path, n_train_examples: int) -> None:
        ...
        self.vlm = FSDP(
            ...
            # cpu_offload=CPUOffload(offload_params=True) if True else None,
        )
        ...
        if self.lr_scheduler_type == "linear-warmup+cosine-decay":
            ...
            #     self.optimizer = Adafactor(groups, lr=self.learning_rate, scale_parameter=True, relative_step=False, warmup_init=False)
            else:

...
from prismatic.training.strategies import FSDPStrategy, FSDP2Strategy, TrainingStrategy
...
TRAIN_STRATEGIES = {
    ...
    "fsdp2-full-shard": {"cls": FSDP2Strategy, "kwargs": {"sharding_strategy": "full-shard"}},
}
